...
define(['views/View', 'models/PlayerModel', 'views/PlayerView', 'collections/ListCollection', 'views/ListView'], function(View, PlayerModel, PlayerView, ListCollection, ListView) {
  'use strict';
