...
define('services/mediator',['require','Backbone'],function(require) {
...
define('views/View',['require','_','Backbone'],function(require) {
  var Backbone, View, _;
  _ = require('_');
  Backbone = require('Backbone');
...
define('models/PlayerModel',['require','Backbone','services/mediator','services/player'],function(require) {
...
define('views/MarqueeView',['require','$','views/View'],function(require) {
...
define('collections/Collection',['require','Backbone'],function(require) {
...
define('services/proxy/LastFm',['require','$'],function(require) {
  var $, LastFm;
  $ = require('$');
...
define('services/proxy/lastFmFilters',['require','jpath','_'],function(require) {
...
define('services/proxy/vkFilters',['require','_'],function(require) {
...
define('services/proxy/proxy',['require','_','services/proxy/lastFmProxy','services/proxy/vkProxy'],function(require) {
...
define('models/TrackModel',['require','$','Backbone','services/mediator','services/proxy/proxy'],function(require) {
...
define('models/SimilarModel',['require','models/TrackModel'],function(require) {
...
define('collections/SimilarsCollection',['require','_','collections/Collection','services/proxy/proxy','models/SimilarModel'],function(require) {
...
define('models/ItemModel',['require','Backbone','models/TrackModel','services/mediator','collections/SimilarsCollection','services/proxy/proxy'],function(require) {
...
define('views/NavigationView',['require','$','services/mediator','views/View','tpl!templates/navigation.html'],function(require) {
...
define('views/MoreButtonView',['require','views/View','tpl!templates/more.html'],function(require) {
...
define('views/SimilarsView',['require','$','_','services/mediator','views/View','views/SimilarView','views/PhraseView','views/MoreButtonView','tpl!templates/similars.html'],function(require) {
...
define('text!templates/info.html',[],function () { return '\n<% if (album) { %>\n\t<span class="b-item-info__album">\n\t\t<span class="b-item-info__album-title">\n\t\t\tАльбом:&nbsp;\n\t\t</span>\n\n\t\t<%= album %>\n\t</span>\n<% } %>\n\n<% if (tags) { %>\n\t<span class="b-item-info__tags">\n\t\t<span class="b-item-info__tags-title">\n\t\t\tЖанры:&nbsp;\n\t\t</span>\n\n\t\t<%= tags %>\n\t</span>\n<% } %>';});

var __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

define('views/InfoView',['require','views/View','tpl!templates/info.html'],function(require) {
...
define('views/ListView',['require','_','vk','services/mediator','views/View','views/ItemView','views/NavigationView'],function(require) {
...
define('text!templates/app.html',[],function () { return '\n<div class="b-app__slider">\n\t<div class="b-app__player-place"></div>\n\t<div class="b-app__navigation-place"></div>\n</div>\n\n<div class="b-app__list-place"></div>';});

var __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

define('views/AppView',['require','services/mediator','vk','views/View','models/PlayerModel','views/PlayerView','collections/ListCollection','views/NavigationView','views/ListView','tpl!templates/app.html'],function(require) {
...
define('services/flow',['require','services/mediator','_'],function(require) {
  var flow, mediator, _;
  mediator = require('services/mediator');
  _ = require('_');
  return flow = {
...
define('services/noty',['require','_','$','services/mediator','humane'],function(require) {
...
define('services/scroll',['require','_','vk','services/mediator'],function(require) {
...
define("libs/backbone/backbone-nested", function(){});
...
define("libs/jquery/jplayer/jquery.jplayer.min", function(){});
...
define("libs/jquery/marquee", function(){});
